...
import image from "../../assets/post images/img2.svg"
    ...
    <Row  style={{width:"60%",}}>
        ...
        <Col >
          <Card>
            ...
            <Card.Body>
              <Card.Title style={{fontFamily: 'IBM Plex Sans', fontSize: '18px', fontStyle: 'normal', fontWeight: 500,}}><LuSchool style={{marginTop:-5}}/> Education</Card.Title>
            ...
            <div className="d-flex flex-row  justify-content-between">
                <div  className="d-flex flex-row  align-items-center ">
                    <img src="../../assets/users/user2.svg"
                    style={{
                        width:"48px",
                        height:"48px",
                        marginLeft:10
