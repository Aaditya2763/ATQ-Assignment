    ...
    <Row  style={{width:"60%",marginTop:15}}>
        ...
        <Col >
          <Card>
            ...
            <Card.Body>
              <Card.Title style={{fontFamily: 'IBM Plex Sans', fontSize: '18px', fontStyle: 'normal', fontWeight: 500,}}><BsSuitcaseLg style={{marginTop:-5}} /> Job</Card.Title>
              <div  className="d-flex flex-row justify-content-between" >
              <Card.Title style={{fontFamily: 'IBM Plex Sans', fontSize: '22px', fontStyle: 'normal', fontWeight: 600,lineHeight:"30px"}}>Software Developer</Card.Title>
             ...
             <span style={{marginLeft:"10%"}}>
              ...
              <Button variant="outline-secondary" className='container' style={{fontFamily: 'IBM Plex Sans', fontSize: '13px', color:'black',fontStyle: 'normal', fontWeight: 600, height:"38px", color:"#02B875"}}> Apply on Timesjobs</Button>

             
            </Card.Body>
            <div className="d-flex flex-row  justify-content-between">
                <div  className="d-flex flex-row  align-items-center ">
                    <img src="../../assets/users/user4.svg"
                    style={{
                        width:"48px",
                        height:"48px",
                        marginLeft:10
                    ...
                    />
                    <p style={{fontFamily: 'IBM Plex Sans', fontSize: '18px', fontStyle: 'normal', fontWeight: 600,color:"black",marginTop:15,paddingLeft:10}}>Joseph Gray</p>
